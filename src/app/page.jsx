...
* @see https://v0.dev/t/yOpT7RKJVyZ
    ...
    (<div className="flex min-h-screen flex-col bg-background">
      <header className="flex items-center h-16 px-4 border-b shrink-0 md:px-6">
        ...
        <nav
          ...
          <Link href="/astro" className="font-bold" prefetch={false}>
            Astrologer
          </Link>
          <Link href="/auth" className="text-muted-foreground" prefetch={false}>
            User Login
          </Link>
        </nav>
      ...
      <section
        className="flex min-h-screen flex-col items-center justify-center bg-background bg-[url('/globe-landing.png')] bg-cover bg-center brightness-75 px-4 py-12 sm:px-6 lg:px-8"
        >
        <div className="container px-4 md:px-6 mx-auto">
          <div
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                <h1
                  ...
                  Unlock the Secrets of the Stars with Our Astrologer Raj Jani
                </h1>
                <p className="max-w-[600px] text-white md:text-xl">
                  Discover your destiny, explore your future, and connect with our expert astrologer.
                </p>
              </div>
           ...
           <MountainIcon
              className="mx-auto aspect-video overflow-hidden rounded-xl object-cover sm:w-full w-60 h-60 lg:order-last lg:aspect-square" />
          </div>
        </div>
      </section>
